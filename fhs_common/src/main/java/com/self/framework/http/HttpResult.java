...
public class HttpResult<T> extends BaseReult {
    ...
    public static <V> HttpResult<V> errorOtherDataResult(V obj){
        HttpResult<V> httpResult = new HttpResult<>();
        httpResult.setCode(HttpCodeConstant.HTTP_ERROR_CODE);
        httpResult.setDescribe(HttpCodeConstant.HTTP_OK_ERROR_DESCRIBE);
        httpResult.setResult(obj);
        return httpResult;
    }
